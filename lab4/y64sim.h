...
// binary display as 0b0ZSO and its default is 0b0100
...
// normal register is from %rax to %r14, besides there is a none register
...
// 0xHI(low 4 bits)LO(low 5~8 bits)
#define HIGH(pack) ((pack)>>4&0xF) // pack low 5~8 bits
#define LOW(pack)  ((pack)&0xF)  // pack low 4 bits
