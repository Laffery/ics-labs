####################################################################
# Description:
# Geneally speaking, the original HCL code is basically completed.
# All I had done is just a implementation of 'iaddq' instruction.
# As is known to all, instruction of 'addq' in y86 can't add a imme-
# -diate number to a register. Luckily, 'iaddq' satisfy this demand.
# Similar to 'seq-full.hcl' in '../seq/', I just add some sentences 
# in {} to support 'iaddq', which are similar to file above as well.
####################################################################
#/* $begin pipe-all-hcl */
####################################################################
...
wordsig D_ifun 'if_id_curr->ifun'	  # Instruction function 
